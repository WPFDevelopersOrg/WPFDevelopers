...
namespace WPFDevelopers.Samples.Passwrod
{
    ...
    public partial class PasswordWithPlainText : UserControl
    {
        ...
        public static readonly DependencyProperty IconImageProperty =
                             DependencyProperty.Register("IconImage", typeof(ImageSource), typeof(PasswordWithPlainText), new PropertyMetadata(new BitmapImage(new Uri("pack://application:,,,/Images/Passwrod/Lock_48px.png"))));
        /// <summary>
        /// 图标
        /// </summary>
