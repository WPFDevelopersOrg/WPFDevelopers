...
namespace WPFDevelopers.Samples.ExampleViews
{
    ...
    public partial class ChatEmojiExample : UserControl
    {
        ...
        void LeftChat()
        {
            ...
            leftText.RightImageSource = new BitmapImage(new Uri("pack://application:,,,/Images/Chat/UserImages/jingtao.png"));
            ...
            rightText.LeftImageSource = new BitmapImage(new Uri("pack://application:,,,/Images/Chat/UserImages/jingtao.png"));
        ...
        void RightChat()
        {
            var leftText = new ChatEmoji();
            leftText.IsRight = true;
            leftText.RightImageSource = new BitmapImage(new Uri("pack://application:,,,/Images/Chat/UserImages/yanjinhua.png"));
            ...
            var rightText = new ChatEmoji();
            rightText.IsRight = false;
            rightText.LeftImageSource = new BitmapImage(new Uri("pack://application:,,,/Images/Chat/UserImages/yanjinhua.png"));
